...
const Courses = () => {
  ...
  return (
    <div>
      ...
      <Dialog open={openAdd} handleClose={() => setOpenAdd(false)} inputs={['اسم الوحدة']} title={'إضافة وحدة'}/>
      <Dialog open={openEdit} handleClose={() => setOpenEdit(false)} inputs={['اسم الوحدة']} title={'تعديل الوحدة'}/>
    </div>
  );
};
